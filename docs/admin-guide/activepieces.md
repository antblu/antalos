...
1. Prepare the external bucket and scoped access, DNS, and certificate prerequisites.
...
Do not put an interactive login challenge in front of incoming webhooks unless the caller supports that authentication path.
