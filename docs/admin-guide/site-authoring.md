...
`site/src/components/Header.astro` keeps the antalos logo, search, GitHub link, and light/dark theme button visible in the header. Avoid overriding the content layout just to align a header element.
