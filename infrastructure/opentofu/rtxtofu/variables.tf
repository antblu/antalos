...
variable "rtx_3060_mapping" {
  type        = string
  description = "Existing Proxmox PCI resource mapping for the complete RTX 3060 device"
  default     = "rtx-3060"
}
