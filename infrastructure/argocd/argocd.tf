...
# The kubeconfig is generated by the Talos/Proxmox stack in ../opentofu
# and written to ../opentofu/kubeconfig. Point the providers at it so this
# directory can talk to the cluster.

provider "kubernetes" {
  config_path = "../opentofu/kubeconfig"
}
